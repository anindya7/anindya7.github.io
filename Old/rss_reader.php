...
function call_rssReader ($rssUrl, $no_of_items, $show_description, $show_date, $font_face, $font_size, $font_color, $text_align, $bgcolor, $bordercolor, $borderwidth) {
	...
	?>
		...
		<table border="<? echo $border_width ?>" <? if($bg_color !='transparent'){ ?> bgcolor="#<? echo $bg_color ?>" <? } if($border_color !='transparent'){ ?> bordercolor="#<? echo $border_color; ?>" <? } ?> style="font-size:<? echo $font_size ?>; font-family:<? echo $font_face ?>;color:#<? echo $font_color ?>">
